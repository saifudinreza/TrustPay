...
export default function Dashboard() {
  ...
  return (
    ...
    >
      {/* ===== NAV ===== */}
      <nav className="no-print" style={{ borderBottom: '1px solid rgba(23,25,29,0.08)', background: 'rgba(239,241,236,0.7)', backdropFilter: 'blur(8px)', position: 'sticky', top: 0, zIndex: 20 }}>
      ...
      <div data-grid className="dash-grid" style={{ maxWidth: 1120, margin: '0 auto', padding: '32px 28px 70px', display: 'grid', gridTemplateColumns: '380px 1fr', gap: 28, alignItems: 'start' }}>
            ...
            {showStamp && (
              <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', pointerEvents: 'none' }}>
                <div data-stamp style={{ width: 128, height: 128, border: '3px solid #4D7C0F', borderRadius: '50%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'rgba(239,241,236,0.92)', boxShadow: '0 18px 40px -14px rgba(190,242,100,0.6)', animation: 'stampIn .5s cubic-bezier(.2,.8,.3,1) both' }}>
                  <span style={{ color: '#4D7C0F', display: 'flex' }}><CheckIcon size={32} strokeWidth={2.6} /></span>
                  <span style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 13, letterSpacing: '0.18em', color: '#4D7C0F', textTransform: 'uppercase', marginTop: 5 }}>Berhasil</span>
                </div>
              </div>
            )}
          </div>
        ...
        <div>
          ...
          <div style={{ background: '#fff', borderRadius: 18, border: '1px solid rgba(23,25,29,0.06)', boxShadow: '0 18px 40px -28px rgba(23,25,29,0.4)', overflow: 'hidden' }}>
            <div style={{ padding: '22px 24px 16px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', borderBottom: '1px solid #eceee8', gap: 12, flexWrap: 'wrap' }}>
              <div>
                <h2 style={{ fontFamily: "'Space Grotesk',sans-serif", fontWeight: 500, fontSize: 20, margin: 0, color: '#17191D' }}>Riwayat Transaksi</h2>
    ...
    <div className="wallet-card" style={{ position: 'relative', borderRadius: 22, padding: '22px 24px', color: '#EFF1EC', overflow: 'hidden', background: 'linear-gradient(150deg,#2C2F35 0%,#191B1F 52%,#0C0E11 100%)', boxShadow: '0 26px 50px -18px rgba(23,25,29,0.6)', transition: 'transform .25s ease, box-shadow .25s ease' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', position: 'relative' }}>
        <div>
          ...
          <div style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 9.5, letterSpacing: '0.22em', textTransform: 'uppercase', color: 'rgba(190,242,100,0.85)', marginTop: 5 }}>Buku Tabungan Digital</div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ width: 96, flex: 'none' }}>
        <div style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 13, color: '#17191D' }}>{tx.dateStr}</div>
      ...
      <span style={{ flex: 1, fontSize: 15, fontWeight: 500, color: '#17191D', minWidth: 60 }}>{m.counterparty}</span>
